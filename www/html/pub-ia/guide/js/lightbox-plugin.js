...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'../images/menu02/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'../images/menu02/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'../images/menu02/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'../images/menu02/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				'../images/menu02/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
		...
		function _show_image_data() {
			...
			if ( settings.imageArray.length > 1 ) {
				$('#lightbox-image-details-currentNumber').html(settings.span + ( settings.activeImage + 1 ) + settings.span2 + settings.txtOf + settings.imageArray.length).show();
			}		
		}
		/**
